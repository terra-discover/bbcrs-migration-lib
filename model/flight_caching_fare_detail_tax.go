...
type FlightCachingFareDetailTax struct {
	basic.Base
	basic.DataOwner
	SessionID *uuid.UUID `json:"session_id,omitempty" gorm:"type:varchar(36);index:idx_flight_caching_fare_detail_tax_session_id;not null"`
	FlightCachingFareDetailTaxAPI
}

type FlightCachingFareDetailTaxAPI struct {
