...
type ProposalOfferDiscount struct {
	basic.Base
	basic.DataOwner
	ProposalOfferDiscountAPI
}

type ProposalOfferDiscountAPI struct {
	ProposalOfferID                         *uuid.UUID `json:"proposal_offer_id,omitempty" gorm:"type:varchar(36);not null" swaggertype:"string" format:"uuid"`
