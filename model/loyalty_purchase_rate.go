...
// LoyaltyPurchaseRate Loyalty Purchase Rate
type LoyaltyPurchaseRate struct {
	basic.Base
	basic.DataOwner
	LoyaltyPurchaseRateAPI
}

// LoyaltyPurchaseRateAPI Loyalty Purchase Rate API
type LoyaltyPurchaseRateAPI struct {
	...
	MinRewardAmount  *float32   `json:"min_reward_amount,omitempty" gorm:"type:decimal(19,4)" example:"1000.00"`                          // Min Reward Amount
}
