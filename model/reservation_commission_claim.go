...
// ReservationCommissionClaim Reservation Commission Claim
type ReservationCommissionClaim struct {
	basic.Base
	basic.DataOwner
	ReservationCommissionClaimAPI
}

// ReservationCommissionClaimAPI Reservation Commission Claim API
type ReservationCommissionClaimAPI struct {
